...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    # TODO: Implement function
	conv_1_by_1=tf.layers.conv2d(vgg_layer7_out,num_classes,1,padding='same',kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
	output=tf.layers.conv2d_transpose(conv_1_by_1,num_classes,4,2,padding='same',kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
	output=tf.add(conv_1_by_1, vgg_layer4_out)
	...
	output=tf.add(conv_1_by_1, vgg_layer3_out)
	#output=tf.layers.conv2d_transpose(output,num_classes,4,2,padding='same',kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
